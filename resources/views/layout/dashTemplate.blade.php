...
<head>
    ...
    <!-- FAVICONS ICON -->
    <link rel="shortcut icon" type="/admin/image/png" href="/admin/images/favicon.png">
    ...
    <div id="main-wrapper">
        ...
        <div class="nav-header">
            <a href="/" class="brand-logo">
                ...
                <div class="brand-title">
                    <h2 class="">Admin</h2>
                    <span class="brand-sub-title">@yusufaa</span>
                </div>
            </a>
                            ...
                            <div class="card-body msg_card_body dlab-scroll" id="DLAB_W_Contacts_Body3">
                                <div class="d-flex justify-content-start mb-4">
                                    <div class="img_cont_msg">
                                        <img src="/admin/images/avatar/1.jpg" class="rounded-circle user_img_msg"
                                            alt="">
                                    </div>
                                ...
                                <div class="d-flex justify-content-end mb-4">
                                    ...
                                    <div class="img_cont_msg">
                                        <img src="/admin/images/avatar/2.jpg" class="rounded-circle user_img_msg"
                                            alt="">
                                    </div>
                                </div>
                                <div class="d-flex justify-content-start mb-4">
        ...
        <div class="dlabnav">
            <div class="dlabnav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li><a href="/" target="_blank" class="" aria-expanded="false">
                            <i class="fas fa-desktop"></i>
                            <span class="nav-text">See Website</span>
                        </a>
                    </li>
                    ...
                    <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="wakatta">Kategori</a></li>
                            <li><a href="wakatta">Subkategori</a></li>
                            <li><a href="wakatta">Slider</a></li>
                            <li><a href="wakatta">Barang</a></li>
                            <li><a href="wakatta">Member</a></li>
                            <li><a href="wakatta">Testimoni</a></li>
                            <li><a href="wakatta">Review</a></li>
                        </ul>
                    </li>
                    ...
                    <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/pesanan/baru">Baru</a></li>
                            <li><a href="/pesanan/dikonfirmasi">Dikonfirmasi</a></li>
                            <li><a href="/pesanan/dikemas">Dikemas</a></li>
                            <li><a href="/pesanan/dikirim">Dikirim</a></li>
                            <li><a href="/pesanan/diterima">Diterima</a></li>
                            <li><a href="/pesanan/selesai">Selesai</a></li>
                        </ul>
                    </li>

                    <li><a href="/" target="_blank" class="" aria-expanded="false">
                            <i class="fas fa-file-invoice-dollar"></i>
                            <span class="nav-text">Laporan Pesanan</span>
                        </a>
                    </li>
                ...
                <div class="side-bar-profile">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        ...
                        <div class="profile-info1">
                            <h4 class="fs-18 font-w500">Yusuf A</h4>
                            <span>y@a.com</span>
                        </div>
        ...
        ***********************************-->
        ...
        <!--**********************************
            Content body start
        ***********************************-->
        {{-- ayaka sayang disini ya contentnya --}}
        @yield('content')
        <!--**********************************
            Content body end
        ***********************************-->
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright © Designed &amp; Developed by <a href="/" target="_blank">DexignLab</a> 2021
                </p>
            </div>
        </div>
        <!--**********************************
